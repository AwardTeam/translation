module.exports = {
  ...
  navbar: {
    ...
    invite: 'Sunucuna Ekle',
    login: 'Giriş'
  },
  footer: {
    rights: 'Tüm hakları saklıdır',
    description: 'Award ile profesyonelce çekilişler oluşturun.',
    menus: {
      first: {
        title: 'Linkler',
        items: {
    ...
    developedWith: 'Award tarafından ❤️ ile geliştirildi.',
    allServices: 'Tüm hizmetler çalışıyor.',
    someServices: 'Bazı hizmetler çalışmıyor.'
  },
  index: {
    title: 'Award ile profesyonel çekilişler oluşturun!',
    ...
    features: {
      title: 'Neden <span class="text-amber-500 font-bold">Award</span>\'ı seçmelisin?',
      description: '\nAward ile gelişmiş çekilişler oluşturun.',
      buttonText: 'Sunucuna davet et!',
      items: [
